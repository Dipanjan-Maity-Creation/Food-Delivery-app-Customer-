...
public final class GeneratedPluginRegistrant {
  ...
  public static void registerWith(@NonNull FlutterEngine flutterEngine) {
    ...
    try {
      flutterEngine.getPlugins().add(new com.ola.map.flutter.ola_map_flutter.OlaMapFlutterPlugin());
    } catch (Exception e) {
      Log.e(TAG, "Error registering plugin ola_map_flutter, com.ola.map.flutter.ola_map_flutter.OlaMapFlutterPlugin", e);
    }
    try {
